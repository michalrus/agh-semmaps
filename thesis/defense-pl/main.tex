...
\begin{frame}[fragile]
	...
	\only<5>{\begin{block}{Moduł regułowy}
	    Używany do wybierania cech i \emph{prawdopodobnie} generowania.
	  \end{block}}
\end{frame}
...
\begin{frame}{Podsumowanie}
	\begin{itemize}
		\item Zwiększa dokładność (nawet do 100\%\ldots)\only<2->{,
		\item ale \alert{bardzo zły User Experience},
